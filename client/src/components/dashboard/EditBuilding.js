...
//     let dataLayer = new L.GeoJSON(props.markers);
//     let layers1 = [];
//     let id = 0;
...
//     return (
//       <div>
//         {activeFloorPolygons.map((layer, i) => {
...
// })
  ...
  function onFloorSelect(e, data) {
    ...
    debugger;
    setActiveFloorPolygons(markers[index].blocks);
    setActiveFloorBoundary(markers[index].boundaries);
    setActiveFloor(markers[index]);
...
<Button color="secondary" onClick={() => toggle("addFloor")}>Cancel</Button>
                ...
                <FeatureGroup>
                  ...
                  {activeFloorPolygons.map((polygonObj,polyIdx)=>(
                      <div>
                      <EditControl
